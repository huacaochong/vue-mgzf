...
var houseList = exports.houseList = function houseList() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var _params$layout = params.layout,
        layout = _params$layout === undefined ? '3室2厅1卫' : _params$layout,
        _params$addr = params.addr,
        addr = _params$addr === undefined ? '普陀区' : _params$addr,
        _params$houseName = params.houseName,
        houseName = _params$houseName === undefined ? '长征佳苑' : _params$houseName,
        _params$area = params.area,
        area = _params$area === undefined ? '60-100' : _params$area,
    ...
    var areaSp = area.split('-'),
        minarea = +areaSp[0],
        maxarea = areaSp[1],
        abs = Math.abs(maxarea - minarea),
        rdm = 0;
    for (var i = 0; i < 10; i++) {
        var n = i % 5;
        daArr = detailedAddress ? [detailedAddress] : [das[n], n < 4 ? das[n + 1] : n % 3 == 0 ? das[n - 1] : das[n % 3]];
...
var _mutations = __webpack_require__(52);
...
var _metro = __webpack_require__(124);

var _metro2 = _interopRequireDefault(_metro);

var _condition = __webpack_require__(50);
...
_vue2.default.mixin({
    changCur: function changCur(target) {
        var _this = this;

        return new Promise(function (resolve, reject) {
            var cur = target.parentNode.getElementsByClassName('cur')[0];
            if (!!cur) _this.removeClass(cur);
            if (cur == target) {
                resolve();
            } else {
...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; } // 异步提交


exports.default = {
    getHouseList: function () {
        var _ref2 = _asyncToGenerator(_regenerator2.default.mark(function _callee(_ref, params) {
            var state = _ref.state;
            var dao, houseName, arr;
...
var actions = {};
var mutations = {
    showMetroList: function showMetroList(state, payload) {
        state.metroList = payload.metroList;
        state.showTag = 'metro';
    },
    updateShowTag: function updateShowTag(state, tag) {
        state.showTag = tag;
    }
};
