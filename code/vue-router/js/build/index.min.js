...
/******/ 	__webpack_require__.p = "./vue-router/js/build/";
/******/
...
var A = { template: '<div>this is a</div>' };
var B = { template: '<div>this is b</div>' };
var C = { template: '<div>this is c</div>' };

// 定义路由
// 每个路由应该映射一个组件。 其中"component" 可以是
// 通过 Vue.extend() 创建的组件构造器，
// 或者，只是一个组件配置对象。
var routes = [{ path: '/a', component: A }, { path: '/b', component: B }, { path: '/c', component: C }];
