...
/******/ 	__webpack_require__.p = "./vue-vuex/js/build/";
/******/
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : global.createVuexLogger = factory();
})(undefined, function () {
  'use strict';
...
var store = new _vuex2.default.Store({
    ...
    // })
    actions: {
        increment2: function increment2(context) {
            // context == state
            // context.state
            // context.getters
            // 异步操作
        ...
        decrease2: function decrease2(_ref) {
            var commit = _ref.commit,
                state = _ref.state;

            commit('decrease');
        },
        increment3: function increment3(_ref2) {
        ...
        decrease3: function decrease3(_ref3) {
            var dispatch = _ref3.dispatch,
                commit = _ref3.commit;

            return dispatch('increment3').then(function () {
                commit('increment');
            });
        }
    },
    ...
    getters: {
        msgLength: function msgLength(state) {
...
var Counter = {
    ...
    methods: _extends({}, (0, _vuex.mapMutations)(['increment', 'decrease']))
};
...
var app = new _vue2.default({
    ...
    computed: (0, _vuex.mapState)({
        ...
        msgName: function msgName(state) {
